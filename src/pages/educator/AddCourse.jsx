        ...
        >
          ...
          <div className="flex items-center justify-between flex-wrap">
            ...
            <input
              ...
              required
              value={coursePrice}
              onChange={(e) => setCoursesPrice(e.target.value)}
            />
          </div>

          <div className="flex md:fex-row items-center gap-3">
          ...
          {/* Adding Chapter and lectureDetails */}
          <div>
            ...
            {showPopup && (
              <div className="fixed inset-0 flex items-center justify-center bg-gray-800/20 bg-opacity-50">
                <div className="bg-white text-gray-400 p-4 rounded relative w-full max-w-80">
