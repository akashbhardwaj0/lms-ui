                  ...
                  <li key={i} className="flex items-start gap-2 py-1 ">
                    ...
                    <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-[15px, 21px">
                      ...
                      <div className="flex gap-2">
                        {lecture.lectureUrl && (
                          <p className="text-blue-500 cursor-pointer" onClick={() => setPlayerData({...lecture, chapter: index+1, lecture:i+1})}>Watch</p>
                        )}
                        <p>{humanizeDuration(lecture.calculateCourseDuration * 60 * 1000, ["h", "m"])}</p>
                      </div>
                    </div>
                  </li>
                ))}
  ...
  return (
    <>
      <div className="flex flext-col-reverse p-4 sm:p-10 md:grid md:grid-cols-2 gap-10 md:px-36">
        ...
        {
        playerData ? (<YouTube videoId={playerData.lectureUrl.split("/").pop} iframeClassName="w-full aspect-video"/>)
