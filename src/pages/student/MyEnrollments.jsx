...
const MyEnrollments = () => {
  const{enrolledCourses, calculateCourseDuration, navigate, userData, fetchUserEnrolledCourses, backendUrl, authToken, calculateNoOfLectures} = useContext(AppContext);
    ...
    try {
      const tempProgressArray = await Promise.all(
        enrolledCourses.map(async (course)=>{
          ...
          const lectureCompleted = result.progressData ? result.progressData.lectureCompleted.length : 0;
